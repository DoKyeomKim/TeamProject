  ...
  <div id="paging" style="margin: 20px 0px; border: 0px solid black">
    <table style="width: 70%; height: 25px; text-align: center" >
     ...
     <c:if test="${ startnum gt 1 }">
       <a href="/BoardPaging/ReviewList?comu_id=COMU01&nowpage=1">⏮</a>
       <a href="/BoardPaging/ReviewList?comu_id=COMU01&nowpage=${ startnum - 1 }">
       ⏪
       </a>
     </c:if>
     ...
     <c:forEach  var="pagenum"  begin="${startnum}"  end="${endnum}"  step="1">
        <a href="/BoardPaging/ReviewList?comu_id=COMU01&nowpage=${ pagenum }">
        ${ pagenum }
        </a>&nbsp;&nbsp;     
     </c:forEach>    
     ...
     <c:if test="${ totalpagecount ne endnum }">
       <a href="/BoardPaging/ReviewList?comu_id=COMU01&nowpage=${ endnum + 1 }">
       ⏩
       </a>
       <a href="/BoardPaging/ReviewList?comu_id=COMU01&nowpage=${ totalpagecount }">⏭</a>
     </c:if>    
