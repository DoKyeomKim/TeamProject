...
<form action="/MyPage/CRecruitWrite" method="post" enctype="multipart/form-data">
    <div class="border border-tertiary w-70 p-5 rounded">

        <h1 style="text-align: center; margin : 0 auto;">
        <input type="text" placeholder="공고 제목을 입력하세요" style="width: 700px; text-align: center;" class="c_title" name="c_title" required></h1>
    ...
    <div class="row">
        ...
        <div class="col-md-8 mt-5">
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="c_company" required>
            </div>
            <div class="input-group mb-3">
                <span class="input-group-text w-25 justify-content-center" style="background-color: #EDF9FF;">모집인원</span>
                <input type="text" class="form-control" name="getman" required>
            </div>
            <div class="input-group mb-3">
                     ...
                     <div class="row justify-content-center ">
                         ...
                         <div  style="margin-top:15px;">
                                 ...
                                 <textarea name="c_info" class="w-100" rows="10"
                                     placeholder="접수기간 : 상시모집" required></textarea>
                             </div>
