...
<a href="/MyPage/CUpdateForm?c_id=${ sessionScope.c_id }" class="list-group-item list-group-item-action">정보수정</a> 
		...
		<main  style="display: grid;">
           ...
           <div class=" mx-2 pb-4 w-100">
                ...
                <form action="/MyPage/CRecruitUpdateForm?cno=${crv.cno }" method="post" enctype="multipart/form-data">
                     ...
                     <div class="row justify-content-center ">
                         ...
                         <div  style="margin-top:15px;">
                                 ...
                                 <textarea name="c_info" class="w-100" rows="10"
                                    readonly >${crv.c_info}</textarea>
                             </div>
                             <div class="d-flex mt-4 justify-content-center">
                                 <div class="px-2">
                                     <button type="submit" class="btn btn-primary">수정</button>
                                     <a href="/MyPage/CManage" class="btn btn-primary">목록으로</a>
                                 </div>
                             </div>
                         </div>
