...
<body style="background-color: #EDF9FF;">
	<div id="container">
		<!-- login Box -->
		<div class="login-box">
			<div id="loginBoxTitle">기업 로그인</div>
			<div class="form-group">
				<form action="/Users/CLogin" method="POST">
					<label>아이디</label> <input type="text" name="c_id"
						class="form-control" required>
			</div>
			<div class="form-group">
				<label>비밀번호</label> <input type="password" name="c_passwd"
			...
			<div style="text-align: center; margin-top: 10px;">
				<a href="/Users/CWriteForm" style="text-decoration: none;">아직 회원이 아니신가요?</a>
			</div>
			</form>
		</div>
	</div>
