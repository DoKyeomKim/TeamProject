...
import com.prj.mypage.domain.CScrapVo;
import com.prj.mypage.mapper.CScrapMapper;
...
public class MyPageController {
	...
	@Autowired
	private CScrapMapper cScrapMapper;
...
//--------------------------기업-------------
		...
		//스크랩
		@ResponseBody
		@RequestMapping("/CScrap")
		public ModelAndView cScrap( CScrapVo cScrapVo ) {
			
			int bno = cScrapVo.getBno();
			
			/*
			 * if (scrap == 0) { service.scrap(Id, bno); } else if(scrap == 1) {
